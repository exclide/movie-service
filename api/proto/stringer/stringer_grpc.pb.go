...
type ReverserClient interface {
	Reverse(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*ReverseResponse, error)
	Counter(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*CountResponse, error)
}
...
func (c *reverserClient) Reverse(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*ReverseResponse, error) {
...
func (c *reverserClient) Counter(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*CountResponse, error) {
	out := new(CountResponse)
	err := c.cc.Invoke(ctx, "/proto.Reverser/Counter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReverserServer interface {
	Reverse(context.Context, *StringRequest) (*ReverseResponse, error)
	Counter(context.Context, *StringRequest) (*CountResponse, error)
...
func (UnimplementedReverserServer) Reverse(context.Context, *StringRequest) (*ReverseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Reverse not implemented")
}
func (UnimplementedReverserServer) Counter(context.Context, *StringRequest) (*CountResponse, error) {
...
func _Reverser_Reverse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverserServer).Reverse(ctx, req.(*StringRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Reverser_Counter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReverserServer).Counter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Reverser/Counter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverserServer).Counter(ctx, req.(*StringRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Reverser_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Counter",
			Handler:    _Reverser_Counter_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/stringer.proto",
}
